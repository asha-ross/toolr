  ...
  return (
    <div>
      ...
      <div className="toolr-card">
        <ul>
          <li>
            Save Money: Avoid the cost of buying tools you might only use once.
          </li>
          <li>
            Reduce Waste: Help promote sustainability by sharing tools instead
            of buying new ones.
          </li>
          <li>
            Support Local Communities: Connect with your neighbors and build
            stronger community bonds.
          </li>
          <li>
            Earn Extra Income: Rent out your unused tools to earn some extra
            cash.
          </li>
        </ul>
      </div>
      <p className="join-toolr">
        Join Toolr today and experience the convenience and benefits of sharing
        tools with your community!
      </p>
    </div>
  )
}
