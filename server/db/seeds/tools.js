...
export async function seed(knex) {
  ...
  await knex('tools').insert([
    ...
    },
    {
      ...
      tool_owner_id: 4,
      description:
        'Lightweight impact driver with high torque for tough tasks.',
    ...
    },
    {
      ...
      tool_owner_id: 5,
      description:
        'Compact and easy to use, ideal for cutting branches and logs.',
    ...
    },
    {
      ...
      tool_owner_id: 7,
      description:
        'A versatile grinder for cutting, grinding, and polishing tasks.',
    ...
    },
    {
      ...
      tool_owner_id: 8,
      description:
        'Lightweight and efficient blower for clearing leaves and debris.',
    ...
    },
    {
      ...
      tool_owner_id: 1,
      description:
        'Powerful petrol-powered brush cutter for tough garden tasks.',
    ...
    },
    {
      ...
      tool_owner_id: 3,
      description:
        'Ideal for smooth planing and trimming edges of wooden surfaces.',
    ...
    },
    {
      ...
      tool_owner_id: 4,
      description:
        'Efficient high-pressure washer for cleaning cars, driveways, and patios.',
    ...
    },
    {
      ...
      tool_owner_id: 6,
      description:
        'Reliable drill for a variety of DIY tasks around the house.',
    ...
    },
    {
      ...
      tool_owner_id: 1,
      description:
        'Durable hammer drill for drilling into concrete and masonry.',
    ...
    },
    {
      ...
      tool_owner_id: 2,
      description:
        'Compact chainsaw suitable for felling small trees and cutting firewood.',
    ...
    },
    {
      ...
      tool_owner_id: 4,
      description:
        'Cordless angle grinder for cutting and grinding in tight spaces.',
    ...
    },
    {
      ...
      tool_owner_id: 5,
      description:
        'Cordless hedge trimmer for shaping and maintaining your hedges.',
    ...
    },
    {
      ...
      tool_owner_id: 6,
      description:
        'Lightweight and powerful blower for clearing leaves and debris.',
    ...
    },
    {
      ...
      tool_owner_id: 7,
      description:
        'Heavy-duty rotary hammer drill for masonry and concrete work.',
